...
const updatePostalCodeApi = async (postalCodeId, payload) => {
  try {
    const url = ENDPOINTS.POSTAL_CODE.replace('{{postalCodeId}}', postalCodeId);
...
export default updatePostalCodeApi;
