...
//Redux
import { getPosChart } from 'src/redux/slices/pointOfService';
...
export default function ContractChart({ pos, chart }) {
      ...
      case 'consumptions':
        return (
          <ChartCard
            ...
            dispatchChartAction={getPosChart}
            objectId={pos?.id}
          />
        );
      case 'events':
